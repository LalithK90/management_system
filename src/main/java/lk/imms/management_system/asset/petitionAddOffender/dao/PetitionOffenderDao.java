...
public interface PetitionOffenderDao extends JpaRepository< PetitionOffender, Long > {
    ...
    List< PetitionOffender > countByOffenderAndCreatedAtBetween(Offender offender, LocalDateTime from,
                                                                LocalDateTime to);

    List< PetitionOffender > findByContravenes(Contravene contravene);

    List< PetitionOffender > findByContravenesAndCreatedAtBetween(Contravene contravene, LocalDateTime from,
                                                                  LocalDateTime to);

    List< PetitionOffender > findByPetitionAndContravenesAndCreatedAtBetween(Petition petition, Contravene contravene
